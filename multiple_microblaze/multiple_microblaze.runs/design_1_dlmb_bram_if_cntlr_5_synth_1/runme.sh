...
HD_PWD='/home/ravi/vivado_projects/multiple_microblaze/multiple_microblaze.runs/design_1_dlmb_bram_if_cntlr_5_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dlmb_bram_if_cntlr_5.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dlmb_bram_if_cntlr_5.tcl
