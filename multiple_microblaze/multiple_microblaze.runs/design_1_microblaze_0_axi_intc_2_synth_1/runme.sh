...
HD_PWD='/home/ravi/ThesisWork/multiple_microblaze/multiple_microblaze.runs/design_1_microblaze_0_axi_intc_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_microblaze_0_axi_intc_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_microblaze_0_axi_intc_2.tcl
