...
HD_PWD='/home/ravi/vivado_projects/multiple_microblaze/multiple_microblaze.runs/design_1_microblaze_2_xlconcat_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_microblaze_2_xlconcat_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_microblaze_2_xlconcat_0.tcl
