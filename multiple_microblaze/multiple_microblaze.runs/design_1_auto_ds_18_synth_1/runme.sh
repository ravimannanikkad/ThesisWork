...
HD_PWD='/home/ravi/ThesisWork/multiple_microblaze/multiple_microblaze.runs/design_1_auto_ds_18_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_ds_18.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_ds_18.tcl
