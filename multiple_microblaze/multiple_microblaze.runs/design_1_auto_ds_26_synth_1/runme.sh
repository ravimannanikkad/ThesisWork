...
HD_PWD='/home/ravi/ThesisWork/multiple_microblaze/multiple_microblaze.runs/design_1_auto_ds_26_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_auto_ds_26.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_auto_ds_26.tcl
